...
function App() {
  ...
  return (
    <>
      ...
      <h2 className="font-canela bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl py-2 md:pt-10 relative z-20 font-bold tracking-tight">
        Carinami
      </h2>
